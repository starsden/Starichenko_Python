...
with sq.connect('store.db') as con:
    ...
    data = [
        ...
        ['Бим Денис Евгеньевич', 'Шаурма с уткой', 'штука', 1, 500],
        ...
        ['Кян Денис Евгеньевич', 'Шаурма с щукой', 'штука', 1, 600],
        ['Кын Денис Евгеньевич', 'Шаурма с овощами', 'штука', 1, 150],
        ['Крык Денис Евгеньевич', 'Шаурма с сыром', 'штука', 1, 400]
    ]
